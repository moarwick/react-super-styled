...
var withMedia = function withMedia() {
  ...
  return function (EnhancedComponent) {
    var _THEME$userTheme = _extends({}, THEME, userTheme),
    ...
    return function (_React$Component) {
      ...
      _createClass(_class2, [{
        ...
        value: function render() {
          ...
          return React.createElement(EnhancedComponent, _extends({ media: this.state.media || 'xs' }, this.props));
        }
      }]);
...
var _temp2 = function () {
  ...
  __REACT_HOT_LOADER__.register(getCurrentMedia, 'getCurrentMedia', 'src/lib/withMedia.js');

  __REACT_HOT_LOADER__.register(getWindowWidth, 'getWindowWidth', 'src/lib/withMedia.js');

  __REACT_HOT_LOADER__.register(withMedia, 'withMedia', 'src/lib/withMedia.js');

  __REACT_HOT_LOADER__.register(_default, 'default', 'src/lib/withMedia.js');
}();
