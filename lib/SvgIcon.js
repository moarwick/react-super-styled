...
var getWrapperCss = function getWrapperCss(props) {
  return (0, _styledComponents.css)(['display:inline-block;position:relative;font-size:0;height:', ';width:', ';', ';'], props.outerHeight, props.outerWidth, (0, _utils.withMediaStyles)(props));
};

var getBackgroundCss = function getBackgroundCss(props) {
  return (0, _styledComponents.css)(['display:inline-block;position:absolute;left:', ';top:', ';background-color:', ';', ' ', ' box-sizing:border-box;', ' height:', ';width:', ';transition:all 0.25s ease;z-index:1;'], props.left, props.top, props.bgColor || 'transparent', props.border ? 'border: ' + props.border + ';' : '', props.radius ? 'border-radius: ' + props.radius + ';' : '', props.onClick ? 'cursor: pointer;' : '', props.sizeX, props.sizeY);
};

var getSvgCss = function getSvgCss(props) {
  return (0, _styledComponents.css)(['position:absolute;left:', ';top:', ';cursor:', ';pointer-events:', ';transition:all 0.25s ease;z-index:2;'], props.left, props.top, props.cursor, props.pointerEvents);
};

var BasicSvg = _styledComponents2.default.svg.withConfig({
  displayName: 'SvgIcon__BasicSvg'
})(['', ';'], function (props) {
  return (0, _utils.withMediaStyles)(props);
});

var Wrapper = _styledComponents2.default.span.withConfig({
  displayName: 'SvgIcon__Wrapper'
})(['', ';'], function (props) {
  return getWrapperCss(props);
});

var Background = _styledComponents2.default.span.withConfig({
  displayName: 'SvgIcon__Background'
})(['', ';'], function (props) {
  return getBackgroundCss(props);
});

var Svg = _styledComponents2.default.svg.withConfig({
  displayName: 'SvgIcon__Svg'
})(['', ';'], function (props) {
...
var SvgIcon = function SvgIcon(props) {
  ...
  return React.createElement(
    Wrapper,
    { innerRef: innerRef, outerHeight: heightUnits, outerWidth: widthUnits, styles: styles },
...
(function () {
  ...
  reactHotLoader.register(DEFAULT_VIEWBOX_SIZE, 'DEFAULT_VIEWBOX_SIZE', 'src/lib/SvgIcon.js');
  reactHotLoader.register(DEFAULT_VIEWBOX, 'DEFAULT_VIEWBOX', 'src/lib/SvgIcon.js');
  reactHotLoader.register(DEFAULT_ICON_SIZE, 'DEFAULT_ICON_SIZE', 'src/lib/SvgIcon.js');
  reactHotLoader.register(XMLNS, 'XMLNS', 'src/lib/SvgIcon.js');
  reactHotLoader.register(parseViewBoxRatio, 'parseViewBoxRatio', 'src/lib/SvgIcon.js');
  reactHotLoader.register(parseDimensions, 'parseDimensions', 'src/lib/SvgIcon.js');
  reactHotLoader.register(getWrapperCss, 'getWrapperCss', 'src/lib/SvgIcon.js');
  reactHotLoader.register(getBackgroundCss, 'getBackgroundCss', 'src/lib/SvgIcon.js');
  reactHotLoader.register(getSvgCss, 'getSvgCss', 'src/lib/SvgIcon.js');
  reactHotLoader.register(BasicSvg, 'BasicSvg', 'src/lib/SvgIcon.js');
  reactHotLoader.register(Wrapper, 'Wrapper', 'src/lib/SvgIcon.js');
  reactHotLoader.register(Background, 'Background', 'src/lib/SvgIcon.js');
  reactHotLoader.register(Svg, 'Svg', 'src/lib/SvgIcon.js');
  reactHotLoader.register(propTypes, 'propTypes', 'src/lib/SvgIcon.js');
  reactHotLoader.register(defaultProps, 'defaultProps', 'src/lib/SvgIcon.js');
  reactHotLoader.register(SvgIcon, 'SvgIcon', 'src/lib/SvgIcon.js');
  reactHotLoader.register(_default, 'default', 'src/lib/SvgIcon.js');
  leaveModule(module);
})();
