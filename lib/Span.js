...
var getCss = function getCss(props) {
  return css(['', '   ', ' ', ' ', ' ', ' ', ' ', ''], props.color && 'color: ' + props.color + ';', props.block && 'display: block;', props.inlineBlock && 'display: inline-block;', withFont(props), withJustify(props), withSpacing(props), withMediaStyles(props));
};
