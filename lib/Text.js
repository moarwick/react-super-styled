...
var getCss = function getCss(props) {
  return css(['color:', ';line-height:', ';', '  ', ' ', ' ', ''], props.color, props.lineHeight, props.margin !== undefined && cssSpacing('margin', props), withFont(props), withJustify(props), withMediaStyles(props));
};
