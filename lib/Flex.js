...
}, basePropTypes, spacingPropTypes, gutterPropTypes, mediaStylesPropTypes);
...
function Flex(props) {
  ...
  var childrenWithGutterProps = React.Children.map(children, function (child) {
    return React.cloneElement(child, { gutter: gutter, smGutter: smGutter, mdGutter: mdGutter, lgGutter: lgGutter });
  });
