...
(function () {
  ...
  reactHotLoader.register(propTypes, 'propTypes', 'src/lib/Flex.js');
  reactHotLoader.register(defaultProps, 'defaultProps', 'src/lib/Flex.js');
  reactHotLoader.register(getCss, 'getCss', 'src/lib/Flex.js');
  reactHotLoader.register(FlexStyled, 'FlexStyled', 'src/lib/Flex.js');
  reactHotLoader.register(Flex, 'Flex', 'src/lib/Flex.js');
  reactHotLoader.register(_default, 'default', 'src/lib/Flex.js');
  leaveModule(module);
})();
