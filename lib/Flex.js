...
var getCss = function getCss(props) {
  return css(['display:', ';flex-direction:', ';flex-wrap:', ';justify-content:', ';align-items:', ';align-content:', ';', ' ', ' ', ' '], props.inline ? 'inline-flex' : 'flex', props.flexDirection, props.flexWrap, props.justifyContent, props.alignItems, props.alignContent, withSpacing(props), withMediaStyles(props), withRowGutters(props));
};
