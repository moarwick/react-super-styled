...
function cssSpacing(rule, value) {
  ...
  return (0, _styledComponents.css)(['', ':', ';'], rule, value);
}
...
function withContainer(props) {
  ...
  // prettier-ignore
  return (0, _styledComponents.css)(['margin-left:auto;margin-right:auto;max-width:', 'px;', '{max-width:', 'px;}', '{max-width:', 'px;}'], props.theme.CONTAINER_SMALL, props.theme.MEDIA_MD_UP, props.theme.CONTAINER_MEDIUM, props.theme.MEDIA_LG_UP, props.theme.CONTAINER_LARGE);
}
...
function withMediaStyles(_ref3) {
  ...
  if ((typeof styles === 'undefined' ? 'undefined' : _typeof(styles)) === 'object') {
    // prettier-ignore
    return (0, _styledComponents.css)(['', ' ', ' ', ' ', ' ', ''], styles.xs && toCssString(styles.xs), styles.sm && theme.MEDIA_SM_UP + ' { ' + toCssString(styles.sm) + ' }', styles.md && theme.MEDIA_MD_UP + ' { ' + toCssString(styles.md) + ' }', styles.lg && theme.MEDIA_LG_UP + ' { ' + toCssString(styles.lg) + ' }', styles.xl && theme.MEDIA_XL_UP + ' { ' + toCssString(styles.xl) + ' }');
  }
...
function withSpacing(props) {
  ...
  // prettier-ignore
  return (0, _styledComponents.css)(['', '  ', ''], props.margin && cssSpacing('margin', props.margin), props.padding && cssSpacing('padding', props.padding));
}
;
