...
function withStyles(_ref4) {
  var styles = _ref4.styles,
      theme = _ref4.theme;

  if ((typeof styles === 'undefined' ? 'undefined' : _typeof(styles)) === 'object') return (0, _styledComponents.css)(['', ';'], styles);

  // prettier-ignore
  return (0, _styledComponents.css)(['', ';', ' ', ' ', ' ', ''], styles.xs, styles.sm && theme.MEDIA_XS_MIN + ' { ' + styles.sm + ' }', styles.md && theme.MEDIA_SM_MIN + ' { ' + styles.md + ' }', styles.lg && theme.MEDIA_MD_MIN + ' { ' + styles.lg + ' }', styles.xl && theme.MEDIA_LG_MIN + ' { ' + styles.xl + ' }');
}
...
(function () {
  ...
  reactHotLoader.register(withRowGutters, 'withRowGutters', 'src/lib/utils.js');
  reactHotLoader.register(columnPropTypes, 'columnPropTypes', 'src/lib/utils.js');
  reactHotLoader.register(withColumns, 'withColumns', 'src/lib/utils.js');
  ...
  reactHotLoader.register(withStyles, 'withStyles', 'src/lib/utils.js');
