...
export function cssSpacing(rule, props) {
  ...
  // prettier-ignore
  return css(['', '-top:', ';', '-right:', ';', '-bottom:', ';', '-left:', ';'], rule, top, rule, right, rule, bottom, rule, left);
}
...
export function withFont(props) {
  ...
  // prettier-ignore
  return css(['', ' ', ' font-size:', ';font-style:', ';font-weight:', ';'], props.inline && 'display: inline;', props.underline && 'text-decoration: underline;', fontSize, fontStyle, fontWeight);
}
