...
function withMediaGutters(_ref) {
  ...
  // prettier-ignore
  var result = (0, _styledComponents.css)(['', ' ', ' ', ' ', ' ', ''], 'xs' in gutter && toMediaGuttersCss(null, gutter.xs), 'sm' in gutter && toMediaGuttersCss(theme.MEDIA_SM_UP, gutter.sm), 'md' in gutter && toMediaGuttersCss(theme.MEDIA_MD_UP, gutter.md), 'lg' in gutter && toMediaGuttersCss(theme.MEDIA_LG_UP, gutter.lg), 'xl' in gutter && toMediaGuttersCss(theme.MEDIA_XL_UP, gutter.xl));
